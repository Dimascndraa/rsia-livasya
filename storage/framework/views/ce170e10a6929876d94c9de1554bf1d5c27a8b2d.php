...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <?php if($post->image): ?>
                                <img src="<?php echo e(asset('public/' . $post->image)); ?>"
                                    class="img-preview img-fluid mb-3 col-sm-5 d-block" alt="<?php echo e($post->image); ?>">
                            <?php else: ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/livasya/resources/views/dashboard/posts/edit.blade.php ENDPATH**/ ?>