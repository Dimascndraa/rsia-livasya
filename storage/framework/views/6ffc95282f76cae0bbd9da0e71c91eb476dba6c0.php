...
unset($__errorArgs, $__bag); ?>" id="title"
                                name="title" placeholder="Masukan Judul" autofocus required value="<?php echo e(old('title')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <select class="form-control <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\rsia-livasya\resources\views/dashboard/posts/create.blade.php ENDPATH**/ ?>