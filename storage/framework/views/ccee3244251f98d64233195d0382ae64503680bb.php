...
<?php $__env->startSection('container'); ?>
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="/dashboard/fasilitas" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name"
                                name="name" placeholder="Masukan Judul" autofocus required value="<?php echo e(old('name')); ?>">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\rsia-livasya\resources\views/dashboard/fasilitas/create.blade.php ENDPATH**/ ?>