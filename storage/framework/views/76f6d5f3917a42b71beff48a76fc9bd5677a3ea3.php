...
<?php $__env->startSection('container'); ?>
    ...
    <div class="card">
        <div class="card-header d-flex  justify-content-center w-100">
            ...
            <a href="/dashboard/pages/about/<?php echo e($about[0]->id); ?>/edit" class="badge mx-1 bg-warning p-2">
        ...
        <div class="card-body align-items-center">
            <div class="row justify-content-center align-items-center">
                <div class="col-sm-6">
                    <img src="<?php echo e(asset('/public/'.$about[0]->image)); ?>" class="img-fluid d-block m-auto" alt="">
                </div>
                <div class="col-sm-6">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/livasya/resources/views/dashboard/about/index.blade.php ENDPATH**/ ?>