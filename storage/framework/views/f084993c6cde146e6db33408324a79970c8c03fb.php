...
unset($__errorArgs, $__bag); ?>" id="title"
                                name="title" placeholder="Masukan judul pelayanan" required value="<?php echo e(old('title')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input id="descript" type="hidden" name="descript" value="<?php echo e(old('descript')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="url"
                                name="url" placeholder="Masukan URL" required value="<?php echo e(old('url')); ?>">
                            <?php $__errorArgs = ['url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/livasya/resources/views/dashboard/pelayanan/create.blade.php ENDPATH**/ ?>