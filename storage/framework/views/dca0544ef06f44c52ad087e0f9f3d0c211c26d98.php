            ...
            <tbody>
                <?php $__currentLoopData = $pelayanans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pelayanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td width="150">
                            <a href="/dashboard/pages/pelayanan/<?php echo e($pelayanan->id); ?>/edit" class="badge mx-1 bg-warning p-2">
                                <i class="fas fa-edit"></i> Ubah
                            </a>
                            <form action="/dashboard/pages/pelayanan/<?php echo e($pelayanan->id); ?>" method="POST" class="d-inline">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/livasya/resources/views/dashboard/pelayanan/index.blade.php ENDPATH**/ ?>