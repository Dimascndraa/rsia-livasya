                ...
                <div class="col-lg-9">
                    <div class="card" style="border: none; border-radius: 20px">
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                <img src="https://source.unsplash.com/400x200/?<?php echo e($fasilitas->name); ?>"
                                    class="img-fluid" alt="<?php echo e($fasilitas->image); ?>" style="border: none; border-radius: 20px">
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/livasya/resources/views/fasilitas/show.blade.php ENDPATH**/ ?>