...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="mb-3">
                            <label for="keterangan_umum" class="form-label">Jadwal Dokter (Umum)</label>
                            <select name="keterangan_umum" id="keterangan_umum" class="form-control">
                                <option value="tidak">Tidak</option>
                                <option value="ya" <?php if($dokter->umum->keterangan_umum == 'ya'): ?> selected <?php endif; ?>>Ya</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-2">
                        <div class="mb-3">
                            ...
                            <input type="text" name="senin_umum" id="senin_umum" class="form-control"
                                value="<?php echo e(old('senin_umum', $dokter->umum->senin_umum)); ?>">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="mb-3">
                            ...
                            <input type="text" name="selasa_umum" id="selasa_umum" class="form-control"
                                value="<?php echo e(old('selasa_umum', $dokter->umum->selasa_umum)); ?>">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="mb-3">
                            ...
                            <input type="text" name="rabu_umum" id="rabu_umum" class="form-control"
                                value="<?php echo e(old('rabu_umum', $dokter->umum->rabu_umum)); ?>">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="mb-3">
                            ...
                            <input type="text" name="kamis_umum" id="kamis_umum" class="form-control"
                                value="<?php echo e(old('kamis_umum', $dokter->umum->kamis_umum)); ?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-2">
                        <div class="mb-3">
                            ...
                            <input type="text" name="jumat_umum" id="jumat_umum" class="form-control"
                                value="<?php echo e(old('jumat_umum', $dokter->umum->jumat_umum)); ?>">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="mb-3">
                            ...
                            <input type="text" name="sabtu_umum" id="sabtu_umum" class="form-control"
                                value="<?php echo e(old('sabtu_umum', $dokter->umum->sabtu_umum)); ?>">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="mb-3">
                            ...
                            <input type="text" name="minggu_umum" id="minggu_umum" class="form-control"
                                value="<?php echo e(old('minggu_umum', $dokter->umum->minggu_umum)); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="mb-3">
                            <label for="keterangan_bpjs" class="form-label">Jadwal Dokter (BPJS)</label>
                            <select name="keterangan_bpjs" id="keterangan_bpjs" class="form-control">
                                <option value="tidak">Tidak</option>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="mb-3">
                            <label for="keterangan_pagi" class="form-label">Jadwal Dokter (Pagi)</label>
                            <select name="keterangan_pagi" id="keterangan_pagi" class="form-control">
                                <option value="tidak">Tidak</option>
                                <option value="ya">Ya</option>
                            </select>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="mb-3">
                            <label for="keterangan_sore" class="form-label">Jadwal Dokter (Sore)</label>
                            <select name="keterangan_sore" id="keterangan_sore" class="form-control">
                                <option value="tidak">Tidak</option>
                                <option value="ya">Ya</option>
                            </select>
                        </div>
    ...
    <script>
        ...
        $(function() {
            $("#keterangan_umum").change(function() {
                if ($(this).val() == "ya") {
                    $("#toggle_umum").show();
                    $("#toggle_umum2").show();
                } else {
            ...
            $("#keterangan_bpjs").change(function() {
                if ($(this).val() == "ya") {
                    $("#toggle_bpjs").show();
                    $("#toggle_bpjs2").show();
                } else {
            ...
            $("#keterangan_pagi").change(function() {
                if ($(this).val() == "ya") {
                    $("#toggle_pagi").show();
                    $("#toggle_pagi2").show();
                } else {
            ...
            $("#keterangan_sore").change(function() {
                if ($(this).val() == "ya") {
                    $("#toggle_sore").show();
                    $("#toggle_sore2").show();
                } else {
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\livasya\resources\views/dashboard/dokter/edit.blade.php ENDPATH**/ ?>