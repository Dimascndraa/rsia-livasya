...
<?php $__env->startSection('container'); ?>
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="/dashboard/pages/about/<?php echo e($about->id); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                required value="<?php echo e(old('nama_instansi', $about->nama_instansi)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="oldImage" value="<?php echo e($about->image); ?>">
                            <?php if($about->image): ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input id="descript" type="hidden" name="descript"
                                value="<?php echo e(old('descript', $about->descript)); ?>">
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input id="sejarah" type="hidden" name="sejarah"
                                value="<?php echo e(old('sejarah', $about->sejarah)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('facebook', $about->facebook)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('instagram', $about->instagram)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="twitter"
                                name="twitter" placeholder="Masukan URL Twitter" required
                                value="<?php echo e(old('twitter', $about->twitter)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('youtube', $about->youtube)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['no_telp1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('no_telp1', $about->no_telp1)); ?>">
                            <?php $__errorArgs = ['no_telp1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['no_telp2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('no_telp2', $about->no_telp2)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control <?php $__errorArgs = ['gmail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('gmail', $about->gmail)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('alamat', $about->alamat)); ?>">
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="number" min="1"
                                class="form-control <?php $__errorArgs = ['jml_dokter'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="jml_dokter"
                                name="jml_dokter" placeholder="Masukan Jumlah Dokter" required
                                value="<?php echo e(old('jml_dokter', $about->jml_dokter)); ?>">
                            <?php $__errorArgs = ['jml_dokter'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="number" min="1"
                                class="form-control <?php $__errorArgs = ['jml_pasien_puas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="jml_pasien_puas"
                                name="jml_pasien_puas" placeholder="Masukan Jumlah Pasien Puas" required
                                value="<?php echo e(old('jml_pasien_puas', $about->jml_pasien_puas)); ?>">
                            <?php $__errorArgs = ['jml_pasien_puas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="number" min="1"
                                class="form-control <?php $__errorArgs = ['jml_fasilitas_kamar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('jml_fasilitas_kamar', $about->jml_fasilitas_kamar)); ?>">
                            <?php $__errorArgs = ['jml_fasilitas_kamar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/livasya/resources/views/dashboard/about/edit.blade.php ENDPATH**/ ?>