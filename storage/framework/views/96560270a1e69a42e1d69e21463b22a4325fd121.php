        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row justify-content-center">
                    <img src="<?php echo e(asset('public/' . $fasilitas->image)); ?>" class="img-fluid img-thumbnail w-50"
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/livasya/resources/views/dashboard/fasilitas/show.blade.php ENDPATH**/ ?>