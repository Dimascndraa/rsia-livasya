        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="/dashboard/admin" class="nav-link <?php echo e(Request::is('dashboard/admin') ? 'active' : ''); ?>">
...
<?php /**PATH D:\laravel\livasya\resources\views/dashboard/partials/sidebar.blade.php ENDPATH**/ ?>