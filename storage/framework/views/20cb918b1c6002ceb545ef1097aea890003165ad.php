            ...
            <div class="col-lg-4">
                <div class="card p-5 hover shadow position-relative" style="border: none; border-radius: 20px">
                    <div class="bg position-absolute"
                        style="background: url('/public/<?php echo e($facility->image); ?>'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                    </div>
                    ...
                    <div class="mt-5" style="z-index: 1">
                        <a href="/fasilitas/<?php echo e($facility->slug); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\03.Laravel\rsialivasya\resources\views/fasilitas/index.blade.php ENDPATH**/ ?>