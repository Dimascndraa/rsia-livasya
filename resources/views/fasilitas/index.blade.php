            ...
            <div class="row justify-content-center g-5">
                ...
                <div class="col-lg-4">
                    <div class="card p-5 hover shadow position-relative" style="border: none; border-radius: 20px">
                        <div class="bg position-absolute" style="background: url('/public/{{ $facility->image }}'); background-repeat: no-repeat; background-size: cover; background-position: center center;"></div>
                        ...
                        <div class="mt-5" style="z-index: 1">
                            <a href="/fasilitas-unggulan/{{ $facility->slug }}">
