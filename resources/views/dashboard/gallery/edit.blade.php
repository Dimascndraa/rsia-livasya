...
@section('container')
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="/dashboard/pages/gallery/{{ $gallery->id }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            @if ($gallery->image)
                                <img src="{{ asset('public/' . $gallery->image) }}"
                                    class="img-preview img-fluid mb-3 col-sm-5 d-block" alt="{{ $gallery->image }}">
                            @else
