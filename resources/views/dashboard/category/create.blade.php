                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <sup>*pilih slug dari judul kategori yang diubah ke bahasa inggris</sup>
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                name="slug" required value="{{ old('slug') }}" placeholder='Masukan format Slug seperti "example-slug"'>
                            @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
